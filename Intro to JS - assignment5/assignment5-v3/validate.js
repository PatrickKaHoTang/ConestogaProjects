...
//		April 6, 2016  - Made all the validations and trim functions
//      April 14, 2016 - Fixed some validations
//

// Validates the Vendor Forms
...
function validateVendorNum2(vendorNum2)
{
	...
	{				
		...
		message += '- You must select a valid vendor\n';
	}
	else
	{
		return true;
...
function validateProvState(provState)
	{
	if (provState == "" || provState == "Default")
	{				
		if (message == "")
		{
			document.getElementById("provState").focus();    
		}
		message += '- You must enter a province or state\n';
	}
	else
	{
		return true;
