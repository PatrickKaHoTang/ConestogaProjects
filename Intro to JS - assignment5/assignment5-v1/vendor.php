...
<body>
	<?php
		...
		function validateVendor()
		{
			...
			$message .= validateProvState($provState,2);
			$message .= validatePostalZip($postalZip);
			$message .= validateCountry($country,3);
		...
		function validateProvState($provState,$x)
			{
			if (strlen($provState) != $x)
			{
				return '- Your must enter the abbreviations for your province or state\n';
			}
			else
			{
				return "";
		...
		function validatePostalZip($postalZip)
		{
			...
			{
				return '- Your zip code must be 5 characters long or your postal code must be 6 characters long\n';
			}
		}
		...
		function validateCountry($country,$x)
			{
			if (strlen($country) < $x || $country == "")
			{
				return '- Your country must be 3 characters long\n';
			}
			else
			{
				return "";
